...
BOT_NAME = "AutomodBot"
FEEDBACK_URL = "https://feedback.Lemmynsfw.com"


## GENERAL ##
GREETING = "Hey,"
PM_SIGNOFF = "I am a Bot. If you have any queries, please contact [Lemmyposter212](/u/bobbiguy2122@lemmynsfw.com). Beep Boop."
AUTOPOST_HELP = (
    ...
    "Finally, if you want to delete a scheduled autopost, use the command `#autopostdelete` with the ID number of the autopost, i.e. `#autopostdelete 1`. You can also delete the latest pinned thread if you include `y` at the end, i.e `#autopostdelete 1 y`. \n\n If you need any further help getting this working, please contact [Demigodrick](/u/demigodrick@Lemmynsfw).")
SUB_ERROR = "Sorry, something went wrong with your request :( \n\n Please message [Lemmyposter212](/u/bobbiguy2122@lemmynsfw.com) directly to let them know, and they'll sort it out for you."
EMAIL_SUBJECT = "Thanks for signing up to Lemmynsfw!"
# WELCOME_MESSAGE = (
#     "\n\n # Welcome to Lemmynsfw! \n\n Please take a moment to familiarise yourself with [our Welcome Post](https://Lemmynsfw/post/43). (Text that looks like this is a clickable link!) \n\n"
...
#     "Please also take a look at our rules, they are in the sidebar of this instance, or you can view them [here](https://legal.Lemmynsfw/posts/code_of_conduct/), or I can send these to you at any time - just send me a message with `#rules`. \n \n"
#     "If you're on a mobile device, you can [tap here](https://m.Lemmynsfw) to go straight to our mobile site. \n \n"
#     "Lemmynsfw is 100% funded by user donations, so if you are enjoying your time on Lemmynsfw please [consider donating](https://opencollective.com/lemmyzip).\n \n"
#     "Want to change the theme of the site? You can go to your [profile settings](https://Lemmynsfw/settings) (or click the dropdown by your username and select Settings) and scroll down to theme. You'll find a list of themes you can try out and see which one you like the most! \n \n"
...
#     "Finally, we've set your account up with some blocks in place. We do this to help you settle in to Lemmy. You can find more details (and how to turn this off) in the [Welcome Post](https://Lemmynsfw/post/43). \n\n"
...
MOD_ADVICE = (
    ...
    # "- There are a couple of mod tools you can use to support your community. You can see the details on our Mod Tools [by clicking here!](/c/modtools@Lemmynsfw) \n"
    "- Consistency is key - you need to post consistently and respond to others to keep engagement with your new community up.\n\n"
    "I hope this helps! \n \n")

## REPORTS ##
REPORT_LOCAL = "Thanks for submitting a report. This is just a message to let you know the mods and admins have recieved this report. We'll check if the reported content breaks our rules and take action accordingly."
REPORT_REMOTE = "Thanks for submitting a report. As this content is on Lemmynsfw, we'll check if it breaks our rules and take action accordingly. Your local admin(s) will also recieve a copy of this report."

# PM REPLIES
# INS_RULES = (
#     "These are the current rules for Lemmynsfw. \n \n"
...
THREAD_LOCK_MESSAGE = (
    "This thread has been locked by the Lemmynsfw Admin Team.")
RSS_HELP = (
    ...
    "Finally, if you want to delete an RSS feed from your community, use the command `#rssdelete` with the ID number of the RSS feed, i.e. `#rssdelete 1`. \n\n If you need any further help getting this working, please contact [Lemmyposter212](/u/bobbiguy2122@lemmynsfw.com).")
LOCAL_ONLY_WARNING = (
    "This bot is only for users of Lemmynsfw. Maybe try signing up there instead if you'd like to try me out!")
CREDITS = (
    "This bot is a fork of a bot that was built with help and support from various lemmy.zip community members and contributers: \n\n"
